...
@Component
public class CustomerJDBCRepo extends AbstractJDBCRepository<Customer, Long> implements Repository<Customer, Long> {
    @Override
    ...
    @Override
    protected Customer buildObj(ResultSet rs) throws SQLException {
        return null;
    }

    @Override
    protected void setDataToCreateQuery(Customer entity, PreparedStatement statement) throws SQLException {

    }

    @Override
    protected void setDataToUpdateQuery(Customer entity, PreparedStatement statement) throws SQLException {
