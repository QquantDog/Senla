...
@Component
public class CabJDBCRepo extends AbstractJDBCRepository<Cab, Long> implements Repository<Cab, Long> {
    @Override
    ...
    @Override
    protected Cab buildObj(ResultSet rs) throws SQLException {
        return null;
    }

    @Override
    protected void setDataToCreateQuery(Cab entity, PreparedStatement statement) throws SQLException {

    }

    @Override
    protected void setDataToUpdateQuery(Cab entity, PreparedStatement statement) throws SQLException {
