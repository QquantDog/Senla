...
@Component
public class CityRateJDBCRepo extends AbstractJDBCRepository<CityRate, Long> implements Repository<CityRate, Long> {
    @Override
    ...
    @Override
    protected CityRate buildObj(ResultSet rs) throws SQLException {
        return null;
    }

    @Override
    protected void setDataToCreateQuery(CityRate entity, PreparedStatement statement) throws SQLException {

    }

    @Override
    protected void setDataToUpdateQuery(CityRate entity, PreparedStatement statement) throws SQLException {
