...
@Component
public class DriverJDBCRepo extends AbstractJDBCRepository<Driver, Long> implements Repository<Driver, Long> {
    @Override
    ...
    @Override
    protected Driver buildObj(ResultSet rs) throws SQLException {
        return null;
    }

    @Override
    protected void setDataToCreateQuery(Driver entity, PreparedStatement statement) throws SQLException {

    }

    @Override
    protected void setDataToUpdateQuery(Driver entity, PreparedStatement statement) throws SQLException {
