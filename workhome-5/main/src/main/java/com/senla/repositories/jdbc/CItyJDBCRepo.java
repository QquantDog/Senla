...
@Component
public class CItyJDBCRepo extends AbstractJDBCRepository<City, Long> implements Repository<City, Long> {
    @Override
    ...
    @Override
    protected City buildObj(ResultSet rs) throws SQLException {
        return null;
    }

    @Override
    protected void setDataToCreateQuery(City entity, PreparedStatement statement) throws SQLException {

    }

    @Override
    protected void setDataToUpdateQuery(City entity, PreparedStatement statement) throws SQLException {
