...
@Component
public class CardJDBCRepo extends AbstractJDBCRepository<Card, Long> implements Repository<Card, Long> {
    @Override
    ...
    @Override
    protected Card buildObj(ResultSet rs) throws SQLException {
        return null;
    }

    @Override
    protected void setDataToCreateQuery(Card entity, PreparedStatement statement) throws SQLException {

    }

    @Override
    protected void setDataToUpdateQuery(Card entity, PreparedStatement statement) throws SQLException {
