...
@Component
public class PromocodeJDBCRepo extends AbstractJDBCRepository<Promocode, Long> implements Repository<Promocode, Long> {
    @Override
    ...
    @Override
    protected Promocode buildObj(ResultSet rs) throws SQLException {
        return null;
    }

    @Override
    protected void setDataToCreateQuery(Promocode entity, PreparedStatement statement) throws SQLException {

    }

    @Override
    protected void setDataToUpdateQuery(Promocode entity, PreparedStatement statement) throws SQLException {
