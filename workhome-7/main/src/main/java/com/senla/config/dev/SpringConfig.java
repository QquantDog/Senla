...
@ComponentScan(basePackages = {"com.senla"}, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {TestContainerConfig.class, TestWebConfig.class}) )
